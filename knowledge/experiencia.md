# Experiencia Laboral — Robert Carvajal Franco

## Globant → Cliente: Disney (Sep 2024 – presente)

**Rol**: Senior Java Engineer
**Proyecto**: Disney Wallet — sistema de wallet centralizado para múltiples plataformas Disney
...
## Image Maker → Cliente: Scotiabank (Sep 2020 – Ago 2024)
...
Responsabilidades:
- Implementación de microservicios con Spring Boot y Spring Security
- Testing exhaustivo con JUnit 5 y MockMvc — cobertura >80%
- Despliegue en Kubernetes con Helm charts

**Stack**: Java 11, Spring Boot, JUnit 5, MockMvc, Kubernetes

---

## Ceiba Software (Jul 2019 – Sep 2020)
...
## Open Systems (2017 – 2019)

**Rol**: Java Developer Junior / Semi-Senior
**Sector**: Sector financiero y empresarial en Colombia

Inicio de carrera. Trabajo con tecnologías más tradicionales pero fundamentales.

Responsabilidades:
- Desarrollo con Spring Framework (versión pre-Boot)
- Bases de datos Oracle 11g con PL/SQL — stored procedures, optimización de queries
